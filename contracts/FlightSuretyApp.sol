...
contract FlightSuretyApp {
    ...
    event FlightRegistered(string flightRef, string to, uint256 landing);
    ...
    constructor(address firstAirlineAddress) public {
        ...
        operational = true;
        flightSuretyData = FlightSuretyData(firstAirlineAddress);
    }
    ...
    function book(
        ...
        paidEnough(
            flightSuretyData
                .getFlightPrice(getFlightKey(airline, flight, timestamp))
                .add(amount)
        )
        checkValue(
            flightSuretyData
